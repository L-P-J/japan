    ...
    <div className="flex flex-1 justify-end gap-8">
      <div className="flex items-center gap-9">
        {["Home", "History", "TotalCosts", "booking","About Us", ].map((menu) => (
          <a key={menu} className="text-sm font-medium text-black" href="#">
            {menu}
          </a>
        ))}
      </div>
      <div
        ...
        style={{
          backgroundImage:
            'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBC1c5JheNpqkkh_OtETu3pG9dFIPkWZwAcSxBQsD-xgJ0MlI3kjIj2ukc_9qA-w9TwmII4odBCF_3g8AXorPmIT5Cp4Zl9pZONU2drkTxu6Ej2Q1QP7eBU8OpvRIuDEv3GdCj6Ei_DYvhwfuAnn9iEjZiqcX6nCosVNwWPzCvj9UEJsKaG5Zch6kmH7ezI7hchvo2X69GiFD_eGwM91lSZUV8skBCufXOilAQqbUwULz_rK4mCQEYcOc6DH431BvskMwuHFII9")',
        }}
      />
    </div>
  </header>
